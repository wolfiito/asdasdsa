...
async function initializeCalendarFromJSON() {
    ...
    // Resto del código para inicializar el calendario con eventos cargados desde el JSON
    initCalendar();
}

// Llamada a la función para cargar eventos desde el archivo JSON
initializeCalendarFromJSON();
...
function getActiveDay(date) {
    ...
    if (dayName in daysDiccionary) {
        dayName = daysDiccionary[dayName]
    }
...
document.addEventListener("click", (e) => {
    if (
        ...
        e.target !== addEventSubmit &&  // Agrega esta condición para evitar cerrar al hacer clic en el botón Agregar Evento
...
async function saveEventsToServer() {
    try {
        ...
        console.log(result);  // Puedes imprimir el resultado en la consola para verificar
    } catch (error) {
        console.error('Error al guardar eventos en el servidor:', error);
    }
}
